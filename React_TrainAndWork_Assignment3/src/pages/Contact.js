...
export default class Contact extends Component {
      ...
      <div className="container">
        <div className="text-center">
          ...
          <h1 className="mb-20 wow fadeIn animated font-xxl fw-900">
            Let's Talk About <br />Your <span className="text-style-1">Idea</span>
          </h1>
          <p className="w-50 m-auto mb-50 wow fadeIn animated">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum quam eius placeat, a quidem mollitia at accusantium reprehenderit pariatur provident nam ratione incidunt magnam sequi.</p>
  ...
  <section className="section-border pt-50 pb-50">
    <div className="container">
      <div id="map-panes" className="leaflet-map mb-50" />
      <div className="row">
        <div className="col-md-4 mb-4 mb-md-0">
          ...
          <a className="btn btn-outline btn-sm btn-brand-outline font-weight-bold text-brand bg-white text-hover-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i className="fi-rs-marker mr-10" />View map</a>
        </div>
        <div className="col-md-4 mb-4 mb-md-0">
          ...
          Chicago, 60601, USA<br />
          <abbr title="Phone">Phone:</abbr> (123) 456-7890<br />
          <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="2a4945445e4b495e6a6f5c4b584b04494547">[email&nbsp;protected]</a><br />
          <a className="btn btn-outline btn-sm btn-brand-outline font-weight-bold text-brand bg-white text-hover-white mt-20 border-radius-5 btn-shadow-brand hover-up"><i className="fi-rs-marker mr-10" />View map</a>
        </div>
        <div className="col-md-4">
          ...
          Chicago, 60601, USA<br />
          <abbr title="Phone">Phone:</abbr> (123) 456-7890<br />
          <abbr title="Email">Email: </abbr><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="791a16170d181a0d393c0f180b18571a1614">[email&nbsp;protected]</a><br />
          <a className="btn btn-outline btn-sm btn-brand-outline font-weight-bold text-brand bg-white text-hover-white mt-20 border-radius-5 btn-shadow-brand hover-up"> <i className="fi-rs-marker mr-10" /> View map</a>
        </div>
      </div>
    </div>
      ...
      <div className="row">
        <div className="col-xl-8 col-lg-10 m-auto">
          <div className="contact-from-area padding-20-row-col wow FadeInUp">
            ...
            <p className="text-muted mb-30 text-center font-sm">Lorem ipsum dolor sit amet consectetur.</p>
